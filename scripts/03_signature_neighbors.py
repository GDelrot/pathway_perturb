...
def main ():
    ...
    for pert_type in ['raw_pert','pathway_pert']:
        ...
        for metadata in ['moa','cluster_id']:
            ...
            #pair_annotated = pair_annotated.iloc[0:500,:]
            ...
            # persist
            sample_stats.to_parquet(OUTPUT / f'nn_purity_samples_{pert_type}_{metadata}.parquet')
            class_stats.to_csv(OUTPUT   / f'nn_purity_classes_{pert_type}_{metadata}.csv')
